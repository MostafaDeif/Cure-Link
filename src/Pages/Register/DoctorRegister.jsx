...
export default function DoctorRegister({ setUser }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const signupData = {
        ...
        // Include additional doctor-specific fields if API supports them
        nationalId,
        gender,
        hospital,
        clinic,
        ...
        <div className="flex flex-col gap-2 mt-2">
          ...
          <div className="mt-3 w-full h-64 rounded-lg overflow-hidden shadow-md border">
            ...
            <p className="text-xs text-gray-500 mt-1">
              اضغط على الخريطة لتحديد مكان العيادة أو اسحب العلامة لتغييره.
            </p>
          </div>
        </div>
