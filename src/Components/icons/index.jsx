...
export const IconUserCircle = (props) => (
  <svg viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" {...props}>
    ...
    <path d="M6 20c1.5-3 4.5-5 6-5s4.5 2 6 5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const IconLayoutDashboard = (props) => (
...
export const IconX = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
